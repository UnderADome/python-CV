...
# # ====================================================
#
# srcTest = r'C:\Users\mushi\Desktop\厅东闸机1\厅东闸机_1.avi'
# srcWebcam = 0
...
#
# def main():
#     camera = cv2.VideoCapture(r'C:\Users\mushi\Desktop\厅东闸机1\厅东闸机_1.avi')
#
#     history = 20
...
if __name__ == '__main__':
    ...
    video = cv2.VideoCapture(r'C:\Users\mushi\Desktop\厅东闸机1\厅东闸机_1.avi')
    ok, frame = video.read()
